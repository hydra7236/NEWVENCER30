...
export const branches: Branch[] = [
  ...
  },
  {
    ...
    color: "fest-cyan",
    events: [
      { title: "Do or die arena", category: "Technical", description: "A brutal robotics arena where only the toughest survive.", prizePool: "?2000", entryFee: "?150", formLink: "#", branch: "R & A", rules: ["Robust robot design required", "Match based scoring", "Safety rules strictly enforced"] },
      { title: "Volleyball", category: "Non-Technical", description: "Dynamic volleyball tournament.", prizePool: "?2000", entryFee: "?150", formLink: "#", branch: "R & A", rules: ["Standard volleyball rules", "Team coordination is key", "Best of 3 sets"] },
      { title: "Robo Race", category: "Technical", description: "High-speed pursuit on a complex track.", prizePool: "?2000", entryFee: "?150", formLink: "#", branch: "R & A", rules: ["Robots must be within size limits", "Fastest lap wins", "No external manual handling allowed"] },
    ],
    culturalEvents: [],
    gamingEvents: [],
  },
